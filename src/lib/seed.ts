...
const toolSeeds: ToolSeed[] = [
  {
    ...
    summary: "Good fit for teams that want one flexible assistant across drafting, synthesis, ideation, and internal knowledge workflows.",
  ...
  },
  {
    ...
    summary: "Good fit for concept art, moodboards, editorial visuals, and teams prioritizing visual quality over workflow integration.",
  ...
  },
  {
    ...
    summary: "Good fit for technical teams that want control, extensibility, and custom visual pipelines.",
  ...
  },
  {
    ...
    summary: "Good fit when repeatable business video, governance, and localization matter more than cinematic generation.",
  ...
  },
  {
    ...
    summary: "Good fit for teams producing narration, localization, and voice interfaces with quality-sensitive output.",
  ...
  },
  {
    ...
    summary: "Good fit for rapid prototypes, learning, and shipping small apps in a hosted development environment.",
  ...
  },
  {
    ...
    summary: "Good fit for users who want quick synthesis with visible sources and a lower-friction search workflow.",
  ...
  },
  {
    ...
    summary: "Good fit for users validating claims against research literature with clearer citation context.",
  ...
  },
  {
    ...
    summary: "Good fit for teams already using Notion for notes, documentation, projects, and internal knowledge.",
  ...
  },
  {
    ...
    summary: "Good fit for operations teams turning repeatable cross-app processes into maintainable automations.",
  ...
  },
  {
    ...
    summary: "Good fit for HubSpot customers looking to add AI assistance without leaving the CRM operating system.",
  ...
  },
  {
    ...
    summary: "Good fit for teams that need targeted coaching and feedback inside seller communication workflows.",
  ...
  },
  {
    ...
    summary: "Good fit for organizations already invested in Tableau that want proactive metrics and guided insights.",
  ...
  },
  {
    ...
    summary: "Good fit for teams that want accessible forecasting and predictive workflows without heavy data science setup.",
